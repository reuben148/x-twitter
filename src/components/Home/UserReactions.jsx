    ...
    return (
        <div className="mt-3">
            ...
            <div className="flex items-center justify-between ">
                ...
                {/* COMMENT BUTTON */}
                <button onClick={handleLike} className="flex items-center text-gray-500 gap-1 hover:text-blue-500 hover:cursor-pointer">
                ...
                {/* REPOST BUTTON */}
                <button onClick={handleLike} className="flex items-center text-gray-500 gap-1 hover:text-green-500 hover:cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 " aria-hidden="true">
                ...
                {/* LOVE BUTTON */}
                <button onClick={handleLike} className="flex items-center text-gray-500 gap-1 hover:text-red-500 hover:cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 " aria-hidden="true">
