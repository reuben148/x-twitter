...
import ReubenBodyMessage from './ReubenBodyMessage'
import ImageUploadPostIcon from '../Home/ImageUploadPostIcon'

export default function UserMessageTwo() {
  return (
    <div className="h-[100vh] flex flex-col">
      ...
      <nav className="sticky top-0 bg-black p-4 z-10 flex items-center justify-between">
        ...
        <div className='flex items-center gap-2.5'>
          <img src="/reuben.jpg" className='w-9 h-9 rounded-full' />
          <h1 className='font-bold text-lg'>Reuben_dev </h1>
        </div>
