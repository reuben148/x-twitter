...
import JethroBodyMessage from './JethroBodyMessage'
    ...
    <div className="h-[100vh] flex flex-col">
      ...
      <nav className="sticky top-0 bg-black p-4 z-10 flex items-center justify-between">
        ...
        <div className='flex items-center gap-2.5'>
          <img src="/jaytee.jpg" className='w-9 h-9 rounded-full' />
          <h1 className='font-bold text-lg'>Jethro IRMIYA </h1>
        </div> 
      ...
      <div className="sticky bottom-0 bg-black p-2 z-10 border-t-2 border-gray-800">
        ...
        <div className='flex gap-4 items-center bg-gray-800 p-3 rounded-xl'>
          ...
          {/* INPUT TEXT FIELD */}
          <input type="text" id='input' placeholder='Start a new message' className='w-full placeholder:font-medium placeholder:focus:border-0 ' />
