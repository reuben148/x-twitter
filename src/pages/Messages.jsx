...
export default function Messages() {
  return (
    <div className='flex h-[100vh] w-full '>
      ...
      {/* MIDDLE FOR EXPLORE */}
      <div className=" w-full md:w-[45%] overflow-y-auto relative no-scrollbar border-r-2 border-gray-900">
      ...
      {/* RIGHT SIDE BAR */}
      <div className=" w-full md:w-[55%] border-r-3 border-gray-800 md:block hidden overflow-y-auto relative no-scrollbar pl-6">
