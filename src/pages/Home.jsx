...
export default function Home() {
  ...
  return (
    ...
    <div className=' border-gray-600 h-[100vh] flex overflow-auto  no-scrollbar '>
      ...
      <div className='w-[40%] fd:block hidden pl-4'>
        ...
        <div>
          ...
          <div className=" relative mt-3 ">
            ...
            <input type="text" id="input-group-1" className=" border-[0.5px] text-white text-[16px] rounded-full focus:border-blue-700 block w-[98%] ps-9 p-2  dark:placeholder-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search"/>
          </div>
